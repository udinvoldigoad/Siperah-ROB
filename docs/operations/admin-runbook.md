...
1. **Pencadangan Database**: Rutin dijalankan otomatis setiap minggu menggunakan GitHub Actions di repositori private terpisah (`saibar-backups`) dengan perintah `pg_dump` versi 17. Berkas backup diunggah sebagai *build artifact* dengan retensi penyimpanan selama **90 hari**.
