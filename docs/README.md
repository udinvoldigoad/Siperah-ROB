...
## ðŸ“š `academic/` â€” Deliverable formal tugas akhir
| Berkas | Isi |
| :--- | :--- |
| [prd.md](academic/prd.md) | Product Requirements Document |
| [skpl.md](academic/skpl.md) | Matriks ketertelusuran kebutuhan â†’ UI/API/test |
...
## âš™ï¸ `operations/` â€” Panduan produksi & teknis
| Berkas | Isi |
| :--- | :--- |
...
## ðŸ¤– `machine-learning/` â€” Metodologi & pipeline ML
| Berkas | Isi |
| :--- | :--- |
