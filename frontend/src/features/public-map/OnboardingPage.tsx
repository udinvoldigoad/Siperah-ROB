  ...
  return (
    <AppShell active="onboarding" title="Panduan Pengguna">
      <div className="content" style={{ maxWidth: 1200, margin: "0 auto", padding: "0 24px 100px" }}>
        ...
        >
          <div style={{ background: "linear-gradient(135deg, #f1f5f9, #e2e8f0)", borderRadius: "32px", padding: "40px", height: "400px", display: "flex", alignItems: "center", justifyContent: "center", overflow: "hidden", position: "relative" }}>
            {/* Abstract Graphic */}
            ...
            <div style={{ background: "rgba(255,255,255,0.9)", backdropFilter: "blur(10px)", padding: "24px", borderRadius: "24px", boxShadow: "0 20px 40px rgba(0,0,0,0.05)", position: "relative", zIndex: 10 }}>
        ...
        >
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: "24px", maxWidth: 900, margin: "0 auto" }}>
            <div style={{ background: "var(--bg)", padding: "32px", borderRadius: "24px", border: "1px solid var(--line)" }}>
        ...
        >
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
            {faqData.map((item, i) => (
              <div key={i} style={{ background: "var(--surface)", border: "1px solid var(--line)", borderRadius: "24px", overflow: "hidden" }}>
                <div 
