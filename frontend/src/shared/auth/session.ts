 ...
 *
 * PENTING — localStorage adalah CACHE, bukan sumber kebenaran. Isinya bisa
 * diubah siapa pun lewat DevTools. Otorisasi yang sesungguhnya ada di server:
 * `EnsureRole` membaca peran dari token Sanctum → database, jadi peran palsu
...
export const SESSION_CHANGED_EVENT = "siperah-session-changed";
 ...
 *
 * Tanpa ini, mengubah `siperah-user.role` jadi "admin" di DevTools membuat UI
